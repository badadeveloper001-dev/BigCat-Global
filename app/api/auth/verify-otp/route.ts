      ...
      if (createdUserId) {
        try {
          await dispatchNotification({
            ...
            type: 'system',
            title: normalizedRole === 'merchant' ? 'Welcome, merchant!' : 'Welcome to BigCat International!',
            ...
            emailSubject: normalizedRole === 'merchant' ? 'Welcome to BigCat International (Merchant)' : 'Welcome to BigCat International',
          })
        } catch (notifyError) {
