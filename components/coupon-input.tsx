...
export function CouponInput({ cartTotal, onCouponApplied, onCouponRemoved }: CouponInputProps) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-700">
                <UiText text={"Saves you"} />{" "}{formatNaira(appliedCoupon.discount)}
              </p>
            </div>
          </div>
          <button
  ...
  return (
    <div className="space-y-2">
      <label className="text-sm font-medium"><UiText text={"Have a coupon code?"} /></label>
      <div className="flex gap-2">
        ...
        >
          ...
          <UiValue value={validating ? 'Checking...' : 'Apply'} />
        </button>
      </div>
