  ...
  return (
    <section className="rounded-2xl border border-border bg-card overflow-hidden">
      <div className="p-4 border-b border-border flex items-center gap-2">
        ...
        <h3 className="font-semibold text-foreground"><UiValue value={title} /></h3>
      </div>

      {orders.length === 0 ? (
        <p className="p-4 text-sm text-muted-foreground"><UiText text={"No protected orders yet."} /></p>
      ) : (
        <div className="divide-y divide-border">
          {orders.slice(0, 6).map((order) => (
            <div key={String(order.id || Math.random())} className="p-4 space-y-2">
              <div className="flex items-center justify-between">
                <p className="text-sm font-semibold text-foreground"><UiText text={"Order"} />{" "}<UiValue value={String(order.id || "").slice(0, 8) || "Pending"} /></p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                <div className="rounded-lg bg-secondary/50 p-2">
                  <p className="text-muted-foreground"><UiText text={"Payment Status"} /></p>
                ...
                <div className="rounded-lg bg-secondary/50 p-2">
                  <p className="text-muted-foreground"><UiText text={"Merchant Verification"} /></p>
                ...
                <div className="rounded-lg bg-secondary/50 p-2">
                  <p className="text-muted-foreground"><UiText text={"Shipment Progress"} /></p>
                ...
                <div className="rounded-lg bg-secondary/50 p-2">
                  <p className="text-muted-foreground"><UiText text={"Buyer Protection"} /></p>
